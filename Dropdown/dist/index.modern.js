...
var Content = function Content(_ref) {
  ...
  return /*#__PURE__*/React.createElement(ContentComponent, {
    ...
    state: state,
    methods: methods
  }) : /*#__PURE__*/React.createElement(React.Fragment, null, props.multi ? state.values && state.values.map(function (item) {
...
var DropdownHandle = function DropdownHandle(_ref) {
  var props = _ref.props,
      state = _ref.state,
      methods = _ref.methods;
  return /*#__PURE__*/React.createElement(DropdownHandleComponent, {
    tabIndex: "-1",
    onClick: function onClick(event) {
...
var Select = /*#__PURE__*/function (_Component) {
  ...
  function Select(_props) {
    ...
    _this.renderDropdown = function () {
      return _this.props.portal ? ReactDOM.createPortal( /*#__PURE__*/React.createElement(Dropdown, {
        props: _this.props,
        state: _this.state,
        methods: _this.methods
      }), _this.dropdownRoot) : /*#__PURE__*/React.createElement(Dropdown, {
        props: _this.props,
        state: _this.state,
        methods: _this.methods
      });
  ...
  _proto.render = function render() {
    ...
    }, /*#__PURE__*/React.createElement(ReactDropdownSelect, _extends({
